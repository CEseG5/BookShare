        ...
        <div class="main-div">
          <div class="panel centerAlign">
           ...
           <?php 
              ...
              if(isset($_POST['update_profile'])){
                ...
                if (empty($newName) && empty($newLastName) && empty($newEmail)) { array_push($errors, "you cannot leave empty fields!"); }
                
                //Description:
                  /*
                    First & last name must contain with a string, upper case letter and must be of length 4.
                  */
         ...
         <form id="Register" method="POST" action="" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" name="nfname" class="form-control" placeholder="update first name">
          </div>
          <div class="form-group">
            <label for="author">Enter Your last name:</label>
            <input type="text" name="nlastname" class="form-control" placeholder="update last name">
          </div>
          <div class="form-group">
            <label for="title">Enter your email:</label>
            <input type="text" name="nemail" class="form-control" placeholder="update email">
          </div> 
